<?php
// Edit Property Page - Full editing functionality for properties (Admin Version)
...
try {
    ...
    if (!$property) {
        ...
        echo '<a href="index.php?page=properties" class="btn btn-primary">Back to Properties</a>';
        exit();
    }

    // Fetch existing images
    $stmt = $conn->prepare("SELECT * FROM property_images WHERE property_id = ? ORDER BY is_primary DESC, upload_date ASC");
    $stmt->execute([$property_id]);
    $existing_images = $stmt->fetchAll(PDO::FETCH_ASSOC);

    // Fetch amenities
    $stmt = $conn->prepare("SELECT amenity FROM property_amenities WHERE property_id = ?");
    $stmt->execute([$property_id]);
    $amenities = $stmt->fetchAll(PDO::FETCH_COLUMN);

} catch (PDOException $e) {
    error_log("Edit Property Error: " . $e->getMessage());
    echo '<div class="error-message">An error occurred while loading the property: ' . $e->getMessage() . '</div>';
    echo '<a href="index.php?page=properties" class="btn btn-primary">Back to Properties</a>';
    exit();
}
?>
...
<div class="dashboard-header">
    ...
    <div>
        <a href="?page=properties" class="btn btn-primary">
    ...
    <form id="editPropertyForm" data-property-id="<?php echo $property_id; ?>">
                ...
                <div class="existing-images-grid">
                    ...
                    <div class="existing-image-item" data-image-id="<?php echo $image['image_id']; ?>">
                        <img src="../<?php echo htmlspecialchars($image['image_path']); ?>"
                             alt="Property Image" onerror="this.src='https://via.placeholder.com/200x150?text=Image+Error'">
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <input type="text" id="editPropertyName" class="form-control" value="<?php echo htmlspecialchars($property['title']); ?>" placeholder="e.g., Modern Family Flat in Gulshan" required>
            </div>

            <div class="form-group">
                <label for="editPropertyAddress">Full Address *</label>
                <input type="text" id="editPropertyAddress" class="form-control" value="<?php echo htmlspecialchars($property['address']); ?>" placeholder="e.g., Gulshan, Dhaka" required>
            </div>

            <div class="form-group">
                <label for="editPropertyCity">Location *</label>
                <select id="editPropertyCity" class="form-control" required>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <select id="editRenterType" class="form-control" required>
            ...
            <div class="form-group">
                ...
                <input type="number" id="editPropertyPrice" class="form-control" value="<?php echo $property['price_per_month']; ?>" placeholder="e.g., 85000" required>
            </div>
        </div>
        ...
        <div class="form-section">
            ...
            <div class="form-row-three">
                <div class="form-group">
                    ...
                    <input type="number" id="editPropertyBedrooms" class="form-control" value="<?php echo $property['bedrooms']; ?>" min="1" placeholder="e.g., 3" required>
                </div>

                <div class="form-group">
                    <label for="editPropertyBathrooms">Bathrooms *</label>
                    <input type="number" id="editPropertyBathrooms" class="form-control" value="<?php echo $property['bathrooms']; ?>" min="1" placeholder="e.g., 3" required>
                </div>

                <div class="form-group">
                    <label for="editPropertyBalcony">Balconies</label>
                    <input type="number" id="editPropertyBalcony" class="form-control" value="<?php echo $property['balconies'] ?? ''; ?>" min="0" placeholder="e.g., 2">
                </div>
            </div>
            ...
            <div class="form-row-three">
                <div class="form-group">
                    ...
                    <input type="number" id="editPropertySize" class="form-control" value="<?php echo $property['area_sqft']; ?>" placeholder="e.g., 1800" required>
                </div>

                <div class="form-group">
                    <label for="editPropertyFloor">Floor Number</label>
                    <input type="text" id="editPropertyFloor" class="form-control" value="<?php echo htmlspecialchars($property['floor_number'] ?? ''); ?>" placeholder="e.g., 5th Floor">
                </div>

                <div class="form-group">
                    <label for="editPropertyFacing">Facing Direction</label>
                    <select id="editPropertyFacing" class="form-control">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="date" id="editAvailableFrom" class="form-control" value="<?php echo $property['available_from'] ?? ''; ?>">
                </div>
            </div>
        </div>
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <textarea id="editPropertyDescription" class="form-control" rows="5" placeholder="Describe your property in detail..." required><?php echo htmlspecialchars($property['description']); ?></textarea>
        ...
        <div class="form-section">
            ...
            <div class="amenities-checkboxes">
                ...
                <label class="checkbox-label">
                    ...
                    <i class="fas fa-<?php
                        $icon = 'check';
                        if (strpos($amenity, 'Kitchen') !== false) $icon = 'utensils';
                        elseif (strpos($amenity, 'Parking') !== false) $icon = 'car';
                        elseif (strpos($amenity, 'Security') !== false) $icon = 'shield-alt';
                        elseif (strpos($amenity, 'Lift') !== false) $icon = 'building';
                        elseif (strpos($amenity, 'Generator') !== false) $icon = 'bolt';
                        elseif (strpos($amenity, 'Garden') !== false) $icon = 'leaf';
                        echo $icon;
                    ?>"></i> <?php echo $amenity; ?>
                </label>
                <?php endforeach; ?>
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <input type="url" id="editMapUrl" class="form-control" value="<?php echo htmlspecialchars($property['map_url'] ?? ''); ?>" placeholder="Paste Google Maps embed URL">
        ...
        <div class="settings-actions">
            <button type="button" class="settings-btn settings-btn-secondary" onclick="window.location.href='index.php?page=properties'">
