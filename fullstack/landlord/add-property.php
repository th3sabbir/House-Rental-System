...
document.getElementById('addPropertyForm').addEventListener('submit', async function(e) {
    ...
    formData.append('status', document.getElementById('addPropertyStatus').value);
    ...
    formData.append('facing_direction', document.getElementById('addPropertyFacing').value || '');
    formData.append('available_from', document.getElementById('addAvailableFrom').value || '');
