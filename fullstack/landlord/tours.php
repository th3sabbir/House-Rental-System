            ...
            <tr>
                <td>
                    <div class="tenant-info">
                        <img src="<?php echo (!empty($tour['tenant_image']) && file_exists('../uploads/' . $tour['tenant_image'])) ? '../uploads/' . $tour['tenant_image'] : 'https://ui-avatars.com/api/?name=' . urlencode($tour['tenant_name']) . '&background=1abc9c&color=fff'; ?>" 
                             alt="Tenant" class="tenant-avatar" onerror="this.src='https://ui-avatars.com/api/?name=<?php echo urlencode($tour['tenant_name']); ?>&background=1abc9c&color=fff';">
                        <div>
...
function openTourModal(tour) {
    ...
    // Tenant image
    const tenantImage = tour.tenant_image && tour.tenant_image.trim() !== ''
        ? '../uploads/' + tour.tenant_image 
        : 'https://ui-avatars.com/api/?name=' + encodeURIComponent(tour.tenant_name) + '&background=1abc9c&color=fff';
    ...
    detailsContainer.innerHTML = `
        <div class="tour-section">
            ...
            <div class="tenant-profile-card">
                <img src="${tenantImage}" alt="${tour.tenant_name}" class="tenant-profile-img" onerror="this.src='https://ui-avatars.com/api/?name=' + encodeURIComponent('${tour.tenant_name}') + '&background=1abc9c&color=fff';">
